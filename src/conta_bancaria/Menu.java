...
public class Menu {
	...
	public static void main(String[] args) {
		...
		System.out.println(Cores.TEXT_YELLOW + "*****************************************************" + Cores.TEXT_RESET);
			...
			System.out.print(Cores.TEXT_CYAN_BOLD + "Entre com a opção desejada: " + Cores.TEXT_RESET); 
	...
	public static void deletarConta() {
		...
		if (conta.isPresent()) {
			...
			System.out.printf("\nTem certeza que vocêdeseja exluir a conta número %d? (S/N)", numero);
	...
	public static void sacar() {
		...
		System.out.println("Digite o saldo do saque: ");
	...
	public static void depositar() {
		...
		System.out.println("Digite o saldo do deposito: ");
		float valor = leia.nextFloat();
		leia.nextLine();
	...
	public static void transferir() {
		...
		System.out.println("Digite o saldo da transferência: ");
		float valor = leia.nextFloat();
		leia.nextLine();
